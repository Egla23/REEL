...
def main():
    ...
    ''''
    python insert_docs.py reelvendornetwork.com [--collection reel] [--db-dir ./chroma_db] [--embedding-model all-MiniLM-L6-v2] [--chunk-size 1000] [--max-depth 3] [--max-concurrent 10] [--batch-size 100]
    '''
